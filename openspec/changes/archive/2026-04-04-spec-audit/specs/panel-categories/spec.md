...
Classify panels into document and tool categories to automatically drive layout preset selection and contextual sidebar content.

## Implementation Notes

All requirements implemented. PANEL_CATEGORY_MAP classifies: document (plan, spec, transcript, file, tasks), tool (git, diff). CATEGORY_TO_PRESET maps to layout presets. activePanelCategoryAtom drives layout changes.
