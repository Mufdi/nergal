...
files:
  ...
  - src/components/panel/FileListView.tsx
---
...
All requirements implemented. CodeMirror 6 with oneDarkHighlightStyle. Language support: TypeScript, JavaScript, JSON, Markdown, CSS, HTML, Rust. Lazy tree expansion via Tauri backend.
